{{--<footer class="container-xxl bg-light layered-box">--}}
{{--    <div class="p-3">--}}
{{--        <hr />--}}
...
{{--            </p>--}}
{{--            <a class="link-warning footer--copyright" href="contact.php">Contacts</a>--}}
{{--            <a class="link-warning footer--copyright" href="about.php">About us</a>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</footer>--}}
<footer class="p-0 m-0 py-3 mb-4 container-xxl bg-light layered-box">
