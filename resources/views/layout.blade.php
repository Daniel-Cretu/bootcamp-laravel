...
<header class="bg-light layered-box">
    <div class="container-xxl p-0 px-sm-1">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="row nav col-12 col-lg-6 m-0 p-0 justify-content-center justify-content-lg-end text-small">
                <li class="col-2 text-center p-0 px-sm-1">
                ...
                <li class="col-2 text-center p-0 px-sm-1">
                    <a href="{{route('blog')}}" class="nav-link text-dark">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-list-columns-reverse  d-block mx-auto mb-1" viewBox="0 0 16 16">
                        ...
                        <div class="d-none d-md-block">Blog</div>
                    </a>
                </li>
                <li class="col-2 text-center p-0 px-sm-1">
                    <a class="nav-link text-dark" data-bs-toggle="offcanvas" data-bs-target="#canvasCart" aria-controls="offcanvasRight">
                        ...
                        <div class="d-none d-md-block">Cart</div>
                    </a>
                </li>
                @auth
                    <li class="col-2 text-center p-0 px-sm-1">
                        <a class="nav-link text-dark"  role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-bag d-block mx-auto mb-1" viewBox="0 0 16 16">
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                                <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                            </svg>
                            <div class="d-none d-md-block text-truncate" title="{{ Auth::user()->name }}">{{ Auth::user()->name }}</div>
                        </a>

                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <li><a class="dropdown-item" href="{{ route('admin.article.create') }}">Create article</a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.product.create') }}">Create product</a></li>
                        </ul>
                    </li>
                    <li class="col-2 text-center p-0 px-sm-1">
                        ...
                        >
                            ...
                            <div class="d-none d-md-block">{{ __('Logout') }}</div>
                        </a>
...
<main class=" flex-grow-1 bg-light layered-box px-0 px-lg-3 container-xxl pt-5">
    @yield('content')
</main>

<footer class="py-3 mb-4 container-xxl bg-light layered-box">
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
        ...
        <li class="nav-item"><a href="{{route('blog')}}" class="nav-link px-2 text-muted">Blog</a></li>
    ...
    <ul class="nav col-12 mb-2 justify-content-center list-unstyled d-flex">
        <li class="ms-3">
